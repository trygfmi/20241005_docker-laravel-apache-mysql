...
source ./errorTest.sh
trap 'error_handler_output_sub_skill "outputSubSkillDataIntoSeeder.sh"; exit 1' ERR 



# echo "outputSubSkillDataIntoSeeder.sh"
# false
...
inputFileName=$1
today=$2
writingFile=$(readlink sub_skill_seeder_symbolic)
insertCreatePokemonTemplateSeedRowNumber=$(grep -n 'DB::table('\''sub_skills'\'')->insert('\\['' ../../../src/database/seeders/PokemonSleep/BackupSeeder.php | cut -d: -f1)
