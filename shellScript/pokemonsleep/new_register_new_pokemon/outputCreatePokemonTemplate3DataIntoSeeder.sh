...
source ./errorTest.sh
trap 'error_handler_output_create_pokemon_template3 "outputCreatePokemonTemplate3DataIntoSeeder.sh"; exit 1' ERR 
...
inputFileName=$1
today=$2
writingFile=$(readlink create_pokemon_template3_seeder_symbolic)
insertCreatePokemonTemplateSeedRowNumber=$(grep -n 'DB::table('\''create_pokemon_template3s'\'')->insert('\\['' ../../../src/database/seeders/PokemonSleep/BackupSeeder.php | cut -d: -f1)
...
# done < 20241229/insertDataToSeeder/create_pokemon_template3.txt
