...
source ./errorTest.sh
trap 'error_handler_output_create_pokemon_template2 "outputCreatePokemonTemplate2DataIntoSeeder.sh"; exit 1' ERR 
...
insertCreatePokemonTemplateSeedRowNumber=$(grep -n 'DB::table('\''create_pokemon_template2s'\'')->insert('\\['' ../../../src/database/seeders/PokemonSleep/BackupSeeder.php | cut -d: -f1)
...
# done < 20241229/insertDataToSeeder/create_pokemon_template2.txt
