...
return new class extends Migration
{
    ...
    {
        Schema::create('create_pokemon_template3s', function (Blueprint $table) {
            ...
            $table->foreignid('main_skill_id')->constrained('main_skills')->onDelete('cascade');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('create_pokemon_template3s');
    }
};
