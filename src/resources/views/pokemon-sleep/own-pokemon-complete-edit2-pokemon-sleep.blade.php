                    ...
                    @foreach($allPokemonList as $apl)
                        ...
                        <div class="col-auto p-0">
                            <div class="position-relative card">
                                @if($apl->remarks == "色違い")
                                    <img src="{{$apl->shiny_image_path}}" alt="{{$apl->own_pokemon_name}}" style="background: white; width: 98px; height: 88px;">
                                @else
                                    <img src="{{$apl->image_path}}" alt="{{$apl->own_pokemon_name}}" style="background: white; width: 98px; height: 88px;">
                                @endif
                                
                                <div class="position-absolute top-0 start-0 d-flex flex-row">
                                    <img src="images/foods/{{$apl->food_lv1}}.png" class="img-fluid" alt="Example Image" style="width: 18px; height: 18px;" data-bs-toggle="tooltip" data-bs-placement="top" title="{{$apl->food_lv1}}">
                                    <img src="images/foods/{{$apl->food_lv30}}.png" class="img-fluid" alt="Example Image" style="width: 18px; height: 18px;" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{$apl->food_lv30}}">
                                    <img src="images/foods/{{$apl->food_lv60}}.png" class="img-fluid" alt="Example Image" style="width: 18px; height: 18px;" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{$apl->food_lv60}}">
                                </div>

                                <div class="position-absolute bottom-0 start-0 d-flex flex-row">
                                    <img src="images/sub_skill_color/sub_skill_gold.png" class="img-fluid" alt="Example Image" style="width: 15px; height: 15px; border: 1px solid;" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{$apl->sub_skill_lv1}}">
                                    <img src="images/sub_skill_color/sub_skill_gold.png" class="img-fluid" alt="Example Image" style="width: 15px; height: 15px; border: 1px solid;" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{$apl->sub_skill_lv25}}">
                                    <img src="images/sub_skill_color/sub_skill_gold.png" class="img-fluid" alt="Example Image" style="width: 15px; height: 15px; border: 1px solid;" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{$apl->sub_skill_lv50}}">
                                    <img src="images/sub_skill_color/sub_skill_gold.png" class="img-fluid" alt="Example Image" style="width: 15px; height: 15px; border: 1px solid;" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{$apl->sub_skill_lv75}}">
                                    <img src="images/sub_skill_color/sub_skill_gold.png" class="img-fluid" alt="Example Image" style="width: 15px; height: 15px; border: 1px solid;" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{$apl->sub_skill_lv100}}">
                                </div>
                            </div>
                        </div>
                    @endforeach
